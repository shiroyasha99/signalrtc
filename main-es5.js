...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _rtc_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./rtc.service */
    ...
    var _signalr_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./signalr.service */
    "./src/app/signalr.service.ts");

    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(rtcService, signalR) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscriptions.add(this.signalR.newPeer$.subscribe(function (user) {
            _this.rtcService.newUser(user);

            _this.signalR.sayHello(_this.currentUser, user.connectionId);
          }));
          this.subscriptions.add(this.signalR.helloAnswer$.subscribe(function (user) {
            _this.rtcService.newUser(user);
          }));
          this.subscriptions.add(this.signalR.disconnectedPeer$.subscribe(function (user) {
            _this.rtcService.disconnectedUser(user);
          }));
          this.subscriptions.add(this.signalR.signal$.subscribe(function (signalData) {
            _this.rtcService.signalPeer(signalData.user, signalData.signal, _this.stream);
          }));
          this.subscriptions.add(this.rtcService.onSignalToSend$.subscribe(function (data) {
            _this.signalR.sendSignalToUser(data.data, data.id);
          }));
          this.subscriptions.add(this.rtcService.onData$.subscribe(function (data) {
            _this.messages = [].concat(_toConsumableArray(_this.messages), [{
              own: false,
              message: data.data
            }]);
            console.log("Data from user ".concat(data.id, ": ").concat(data.data));
          }));
          this.subscriptions.add(this.rtcService.onStream$.subscribe(function (data) {
            _this.userVideo = data.id;
            _this.videoPlayer.nativeElement.srcObject = data.data;
        ...
        key: "onUserSelected",
        value: function onUserSelected(userInfo) {
          var peer = this.rtcService.createPeer(this.stream, userInfo.connectionId, true);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return this.signalR.startConnection(this.currentUser);
                  ...
                  case 8:
                    ...
                    console.error("Can't join room, error ".concat(_context.t0));
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_6__["UserListComponent"]],
  ...
  /***/
  function srcAppRtcServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RtcService", function () {
      return RtcService;
    });
    /* harmony import */
    ...
    var RtcService = /*#__PURE__*/function () {
      function RtcService() {
        _classCallCheck(this, RtcService);
      ...
      _createClass(RtcService, [{
        key: "newUser",
        value: function newUser(user) {
          this.users.next([].concat(_toConsumableArray(this.users.getValue()), [user]));
        }
      }, {
        key: "disconnectedUser",
        value: function disconnectedUser(user) {
          var filteredUsers = this.users.getValue().filter(function (x) {
            return x.connectionId === user.connectionId;
          });
          this.users.next(filteredUsers);
        }
      }, {
        key: "createPeer",
        value: function createPeer(stream, userId, initiator) {
          var _this2 = this;
          ...
          peer.on('stream', function (data) {
            ...
            _this2.onStream.next({
              id: userId,
              data: data
            });
          });
          peer.on('connect', function () {
            _this2.onConnect.next({
              id: userId,
              data: null
            });
          });
        ...
        key: "signalPeer",
        value: function signalPeer(userId, signal, stream) {
    ...
    RtcService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], RtcService);
    /***/
  },
  ...
  /***/
  function srcAppSignalrServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SignalrService = /*#__PURE__*/function () {
      ...
      _createClass(SignalrService, [{
        key: "startConnection",
        value: function startConnection(currentUser) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    this.hubConnection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_2__["HubConnectionBuilder"]().withUrl('https://testsignalrtc.azurewebsites.net/signalrtc').build();
                    _context2.next = 3;
                    return this.hubConnection.start();

                  case 3:
                    console.log('Connection started');
                    this.hubConnection.on('NewUserArrived', function (data) {
                      _this3.newPeer.next(JSON.parse(data));
                    });
                    this.hubConnection.on('UserSaidHello', function (data) {
                      _this3.helloAnswer.next(JSON.parse(data));
                    });
                    this.hubConnection.on('UserDisconnect', function (data) {
                      _this3.disconnectedPeer.next(JSON.parse(data));
                    });
                    this.hubConnection.on('SendSignal', function (user, signal) {
                      _this3.signal.next({
                        user: user,
                        signal: signal
                      });
        ...
        key: "sendSignalToUser",
        value: function sendSignalToUser(signal, user) {
          this.hubConnection.invoke('SendSignal', signal, user);
        }
      }, {
        key: "sayHello",
        value: function sayHello(userName, user) {
    ...
    SignalrService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], SignalrService);
    /***/
  },
  ...
  /***/
  function srcAppUserListUserListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUserListUserListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserListComponent = /*#__PURE__*/function () {
      function UserListComponent(rtcService) {
      ...
      _createClass(UserListComponent, [{
        ...
        key: "userClicked",
        value: function userClicked(user) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], UserListComponent.prototype, "userSelected", void 0);
    UserListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/user-list/user-list.component.scss"))["default"]]
    })], UserListComponent);
    /***/
  },
